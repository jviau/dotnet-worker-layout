...
internal static class Check
{
    ...
    public static T NotDefault<T>(T argument, [CallerArgumentExpression(nameof(argument))] string? name = default)
        where T : struct
    {
    ...
    public static string NotNullOrEmpty(
        [NotNull] string? argument, [CallerArgumentExpression(nameof(argument))] string? name = default)
    {
        if (argument is null)
        {
            throw new ArgumentNullException(name);
    ...
    public static void ConcreteType<TImplements>(
        [NotNull] Type? argument, [CallerArgumentExpression(nameof(argument))] string? name = default)
    {
    ...
    public static T IsType<T>(
        [NotNull] object? argument, [CallerArgumentExpression(nameof(argument))] string? name = default)
    {
        NotNull(argument, name);
